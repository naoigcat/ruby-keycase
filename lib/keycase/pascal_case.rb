...
module Keycase
  module PascalCase
    ...
    refine String do
      def to_pascal_case(acronyms: nil)
        Keycase::PascalCase.convert_string(self, acronyms: acronyms)
      end
    end

    refine Symbol do
      def to_pascal_case(acronyms: nil)
        Keycase::PascalCase.convert(self, acronyms: acronyms)
      end
    end
  ...
  class << self
    def pascal_case(value, acronyms: nil)
      PascalCase.convert(value, acronyms: acronyms)
    end

    def with_pascal_case_keys(value, options = {})
      PascalCase.convert_keys(value, options)
    end
  end
end
